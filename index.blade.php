...
<head>
	...
	<link href="{{asset('https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;600&family=Roboto&display=swap')}}"  rel="stylesheet" />
	<!-- Icons CSS -->
	<link href="{{asset('assets/css/icons.css')}}"  rel="stylesheet" />
	<!-- App CSS -->
	<link href="{{asset('assets/css/app.css')}}"  rel="stylesheet" />
	<link href="{{asset('assets/css/dark-sidebar.css')}}"  rel="stylesheet" />
...
<body>
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				<li>
					...
					<ul>
						<li> <a href="{{asset('index.html')}}"><i class="bx bx-right-arrow-alt"></i>Analytics</a>
						</li>
						<li> <a href="{{asset('index2.html')}}"><i class="bx bx-right-arrow-alt"></i>Sales</a>
						</li>
					</ul>
				</li>
				<li class="menu-label">Web Apps</li>
				<li>
					<a href="{{asset('emailbox.html')}}">
				...
				<li>
					...
					<ul>
						...
						<li> <a href="{{asset('component-bedges.html')}}"><i class="bx bx-right-arrow-alt"></i>Badge</a>
						</li>
						...
						<li> <a href="{{asset('component-carousels.html')}}"><i class="bx bx-right-arrow-alt"></i>Carousel</a>
						</li>
						<li> <a href="{{asset('component-acordians.html')}}"><i class="bx bx-right-arrow-alt"></i>Acordians</a>
						</li>
						...
						</li>{{asset('component-list-groups.html')}}
				...
				<li>
					...
					<ul>
						...
						<li> <a href="{{asset('table-editable.html')}}"><i class="bx bx-right-arrow-alt"></i>Editable Table</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li> <a href="{{asset('authentication-login.html')}}" target="_blank"><i class="bx bx-right-arrow-alt"></i>Login</a>
						</li>
						<li> <a href="{{asset('authentication-register.html')}}" target="_blank"><i class="bx bx-right-arrow-alt"></i>Register</a>
						</li>
				...
				<li>
					...
					<ul>
						<li> <a class="has-arrow" href="{{asset('javascript:;')}}"><i class="bx bx-right-arrow-alt"></i>Level One</a>
							<ul>
								<li> <a class="has-arrow" href="{{asset('javascript:;')}}"><i class="bx bx-right-arrow-alt"></i>Level Two</a>
									<ul>
										<li> <a href="{{asset('javascript:;')}}"><i class="bx bx-right-arrow-alt"></i>Level Three</a>
										</li>
									</ul>
								</li>
							</ul>
				...
				<li>
					<a href="{{asset('https://codervent.com/syndash/documentation/index.html')}}" target="_blank">
							...
							<div class="table-responsive">
								<table class="table mb-0">
									...
									<tbody>
										<tr>
											<td>1</td>
											<td><a href="{{asset('https://themeforest.net/item/synadmin-bootstrap4-admin-template/29014766')}}" target="_blank">{{asset('https://themeforest.net/item/synadmin-bootstrap4-admin-template/29014766')}}</a>
											</td>
											<td>660</td>
											<td>55s</td>
											<td>3.6%</td>
										...
										<tr>
											<td>2</td>
											<td><a href="{{asset('https://codervent.com/wipe-admin-dark/dashboard/v3')}}" target="_blank">{{asset('https://codervent.com/wipe-admin-dark/dashboard/v3')}}</a>
											</td>
											<td>352</td>
											<td>16s</td>
											<td>8.4%</td>
										...
										<tr>
											<td>3</td>
											<td><a href="{{asset('https://themeforest.net/item/dashtreme-multipurpose-bootstrap4-admin-template/23059455')}}" target="_blank">{{asset('https://themeforest.net/item/dashtreme-multipurpose-bootstrap4-admin-template/23059455')}}</a>
											</td>
											<td>101</td>
											<td>10s</td>
											<td>6.7%</td>
										...
										<tr>
											<td>4</td>
											<td><a href="{{asset('https://themeforest.net/item/rukada-responsive-bootstrap-4-admin-template/22820477')}}" target="_blank">{{asset('https://themeforest.net/item/rukada-responsive-bootstrap-4-admin-template/22820477')}}</a>
											</td>
											<td>95</td>
											<td>57s</td>
											<td>5.2%</td>
										...
										<tr>
											<td>5</td>
											<td><a href=" {{asset('https://codervent.com/rocker-angular/dashboard/v1')}}" target="_blank">https://codervent.com/rocker-angular/dashboard/v1</a>
											</td>
											<td>102</td>
											<td>45s</td>
											<td>7.2%</td>
		...
		<!--footer -->
		<div class="footer">
			<p class="mb-0">Syndash @2020 | Developed By : <a href="{{asset('https://themeforest.net/user/codervent')}}" target="_blank">codervent</a>
			</p>
		</div>
		<!-- end footer -->
	</div>
